...
#endif
{
    ...
    xTaskCreate((pdTASK_CODE)thread_entry_func, 
                (const signed char * const)thread_name, 
                thread_stack_size,
                thread_arg,
                thread_priority,
                thread_handle);
...
* Remarks    : 
*******************************************************************************/
void OSA_InitSemaphore(osa_semaphore_type_t *sem, U32 init_value,U32 max)
{
...
* Remarks    : 
*******************************************************************************/
BOOLEAN OSA_TakeSemaphore_Timeout(osa_semaphore_type_t *sem, U32 timeout_ms)
{
...
* Remarks    :
*******************************************************************************/
BOOLEAN OSA_InitMsgQue(osa_msgq_type_t* mq_handler,U8 *mq_name, U32 max_msgs, U32 msg_size)
{
#ifdef LINUX
    struct mq_attr attr;
...
#else
BOOLEAN OSA_SendMsgQue(osa_msgq_type_t* mq_handler,U8 *buffer, U32 size)
#endif
{
#ifdef LINUX
    INT32 ret = -1;
...
*******************************************************************************/
#ifdef FREERTOS_KERNEL
S32 OSA_SendMsgQueTimeout(osa_msgq_type_t mq_handler,void *msg,  U32 timeout_ms )
#else
S32 OSA_SendMsgQueTimeout(osa_msgq_type_t* mq_handler,U8 *buffer, U32 size, U32 time_sec)
#endif
{
#ifdef LINUX
    INT32 len = -1;
...
#else
BOOLEAN OSA_ReceiveMsgQue(osa_msgq_type_t* mq_handler,U8 *buffer, U32 size)
#endif
{
#ifdef LINUX
    INT32 ret = -1;
...
*******************************************************************************/
#ifdef FREERTOS_KERNEL
S32 OSA_ReceiveMsgQueTimeout(osa_msgq_type_t mq_handler,void **msg, U32 timeout_ms)
#else
S32 OSA_ReceiveMsgQueTimeout(osa_msgq_type_t* mq_handler,U8 *buffer, U32 size, U32 time_sec)
#endif
{
#ifdef LINUX
    INT32 len = -1;
...
*******************************************************************************/
#ifdef FREERTOS_KERNEL
U32 OSA_ReceiveMsgQueIsr(osa_msgq_type_t mq_handler, void **msg)
{
    void *dummyptr;
...
*******************************************************************************/
BOOLEAN OSA_DeinitMsgQue(osa_msgq_type_t* mq_handler, U8* mq_name)
{
#ifdef LINUX
    INT32 ret = -1;
...
void OSA_Usleep(U32 time_usec)
{
    ...
    U32 msec = time_usec/1000;
    vTaskDelay(msec/OSA_TICK_RATE_MS);
#endif
}
...
* Remarks    :
*******************************************************************************/
U32 OSA_InitTimer(osa_timer_type_t *timer, osa_time_type_t period_ms, BOOLEAN is_periodic, Callback_1_Arg function, void *arg)
{
#ifdef FREERTOS_KERNEL
	...
	timer->handle = (void *)xTimerCreate((signed char *)"timer", ticks, is_periodic, (void *)timer, osa_TimerCallback);
...
* Remarks    :
*******************************************************************************/
U32 OSA_StartTimer(osa_timer_type_t *timer)
{
#ifdef FREERTOS_KERNEL
...
* Remarks    :
*******************************************************************************/
U32 OSA_ResetTimer(osa_timer_type_t *timer)
{
#ifdef FREERTOS_KERNEL
...
* Remarks    :
*******************************************************************************/
U32 OSA_StopTimer(osa_timer_type_t *timer)
{
#ifdef FREERTOS_KERNEL
...
* Remarks    :
*******************************************************************************/
U32 OSA_DeInitTimer(osa_timer_type_t *timer)
{
#ifdef FREERTOS_KERNEL
    xTimerHandle   handle;
...
//	timer->function = NULL;
//	timer->arg = 0x00;
	memset((U8*)timer,0x00, sizeof(osa_timer_type_t));
